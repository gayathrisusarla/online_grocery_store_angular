...
DROP TABLE IF EXISTS `saluation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `saluation` (
  `saluation_id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `saluation` WRITE;
/*!40000 ALTER TABLE `saluation` DISABLE KEYS */;
INSERT INTO `saluation` VALUES (1,'Mr.'),(2,'Mrs.');
/*!40000 ALTER TABLE `saluation` ENABLE KEYS */;
UNLOCK TABLES;
